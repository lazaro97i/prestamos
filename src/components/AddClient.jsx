...
const AddClient = () => {
  return (
    <div className='fixed px-1 top-0 left-0 w-full h-screen flex flex-col justify-center items-center bg-slate-950 bg-opacity-50'>
      <div className=' w-full rounded-md md:w-4/5 bg-slate-400 flex flex-col py-10'>
        ...
        <form action="get">
          <label className='flex flex-wrap items-center justify-center md:grid md:grid-cols-3 gap-2 px-10 text-slate-950 font-[500] mb-5'>
            ...
            '>Nombre y Apellido:</p>
            <input className='w-full col-span-2 h-auto rounded-sm p-1 px-3 outline-none bg-slate-300 bg-opacity-40' type="text" name="name" id="name" />
          </label>
          <label className='flex flex-wrap items-center justify-center md:grid md:grid-cols-3 gap-2 px-10 text-slate-950 font-[500] mb-5'>
            <p className=' text-start w-full md:w-auto col-span-1
            '>Documento:</p>
            <input className='w-full col-span-2 h-auto rounded-sm p-1 px-3 outline-none bg-slate-300 bg-opacity-40' type="number" name="dni" id="dni" />
          </label>
          <label className='flex flex-wrap items-center justify-center md:grid md:grid-cols-3 gap-2 px-10 text-slate-950 font-[500] mb-5'>
            <p className=' text-start w-full md:w-auto col-span-1
            '>Celular:</p>
            <input className='w-full col-span-2 h-auto rounded-sm p-1 px-3 outline-none bg-slate-300 bg-opacity-40' type="number" name="phone" id="phone" />
          </label>
          <label className='flex flex-wrap items-center justify-center md:grid md:grid-cols-3 gap-2 px-10 text-slate-950 font-[500] mb-5'>
            <p className=' text-start w-full md:w-auto col-span-1
            '>Direccion:</p>
            <input className='w-full col-span-2 h-auto rounded-sm p-1 px-3 outline-none bg-slate-300 bg-opacity-40' type="text" name="address" id="address" />
          </label>
          <label className='flex flex-wrap items-center justify-center md:grid md:grid-cols-3 gap-2 px-10 text-slate-950 font-[500]'>
            <p className=' text-start w-full md:w-auto col-span-1
            '>Barrio / Ciudad:</p>
            <input className='w-full col-span-2 h-auto rounded-sm p-1 px-3 outline-none bg-slate-300 bg-opacity-40' type="text" name="city" id="city" />
          </label>
